...
<body>
    ...
    <div class="panel-main flex flex-col gap-3">
        ...
        <div class="flex flex-row justify-between gap-3 w-full">
            <div class="w-auto">
                <button id="btnBuscar" class="btn-gray btn-s py-1 px-20 text-black" onclick="BuscadorHerramienta();">Buscar</button>
                <button id="btnBuscar" class="btn-gray btn-s py-1 px-20 text-black" onclick="Restablecer();">Restablecer</button>
            </div>
            <div class="w-auto">
                <button id="btn-m-agregar" class="btn-primary btn-s py-1 px-7 relative" style="right: 0px">Agregar herramienta</button>
            </div>
        </div>
    ...
    <div id="modal-agregar" class="hidden fixed z-10 inset-0 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-32 sm:align-middle sm:w-2/4">
                ...
                <div class="flex flex-col bg-white gap-y-5 py-5 px-20">
                    ...
                    <div class="w-full flex flex-col">
                        ...
                        <input type="text" name="HerramientaNme" id="Herramienta_N" class="campo_B p-1 border-2 border-gray-300">
                    </div>
                    <div class="w-full flex flex-row gap-x-3">
                        <div class="flex flex-col">
                            <h2 class="label-text">Código*</h2>
                            <input type="text" name="" id="ID_cod" class="campo_B upcase p-1 border-2 border-gray-300">
                        </div>
                    <div class="flex flex-col">
                        <h2 class="label-text">Cantidad total </h2>
                        <input type="number" name="" id="cantidad_t" value="0" class="campo_B p-1 border-2 border-gray-300">
                    </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-x-2">
                <button id="btnAgregar" onclick="AgregarHerramienta();" class="btn-primary btn-s py-1 px-7 w-1/4">
                        Agregar
                </button>
    ...
    <div id="modal-mod" class="hidden fixed z-10 inset-0 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-32 sm:align-middle sm:w-2/4">
                <div class="bg-blue-950 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="w-full px-10 h-24 bg-blue-950 grid content-center">
                        <h1 class="text-5xl text-center text-white title-seccion"> Información de la herramienta </h1>
                    </div>
                </div>
                <div class="flex flex-col bg-white gap-y-5 py-5 px-10">
                    <div class="w-full flex flex-col gap-y-2 py-5 px-5">
                        ...
                        <div class="w-full flex flex-col">
                            ...
                            <input type="text" name="HerramientaNme" id="Herramienta-m" class="campo_B p-1 border-2 border-gray-300">
                        </div>
                        <div class="w-full flex flex-row gap-x-3">
                            <div class="flex flex-col">
                                <h2 class="label-text">Cantidad total</h2>
                                <input type="number" name="" id="CantidadEdit" class="campo_B p-1 border-2 border-gray-300">
                            </div>
                            <div class="flex flex-col">
                                <h2 class="label-text">Cantidad disponible</h2>
                                <input type="number" name="" id="CantidadDis_Edit" class="campo_B p-1 border-2 border-gray-300" disabled>
                            </div>
                            <div class="flex flex-col w-1/4">
                                <h2 class="label-text">Estado</h2>
                        ...
                        <div class="w-full flex flex-row gap-x-3">
                            <div class="flex flex-col w-full">
                                <h2 class="label-text">Descripción</h2>
                                <textarea id="descripcionEdit" class="campo_B p-1 border-2 border-gray-300"></textarea>
                        </div>
                    </div>
                    <div class="w-full flex flex-col gap-y-3">
                        ...
                        <div class="w-full flex flex-row justify-between">
                            ...
                            <div class=" ">
                            <a href="">
                                <button class="btn-primary btn-s py-1 px-7">Ver información</button>
                            </a>
                        </div>
                    </div>
                    <div id="Tabla" class="w-full ">
                        <table class="table-fixed w-full border-collapse border border-blue-950 ">
                            <thead class="">
                                <tr>
                                    <th class="border border-blue-900">Folio</th>
                                    <th class="border border-blue-900">Nombre</th>
                                    <th class="border border-blue-900">Cantidad</th>
                                    <th class="border border-blue-900">Fecha prestamo</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="border border-blue-700">1</td>
                                    <td class="border border-blue-700">1</td>
                                    <td class="border border-blue-700">1</td>
                                    <td class="border border-blue-700">1</td>
                                </tr>
                                <tr>
                                    <td class="border border-blue-700">2</td>
                                    <td class="border border-blue-700">2</td>
                                    <td class="border border-blue-700">2</td>
                                    <td class="border border-blue-700">2</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="border border-blue-700">3</td>
                                    <td class="border border-blue-700">3</td>
                                    <td class="border border-blue-700">3</td>
                                    <td class="border border-blue-700">3</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="border border-blue-700">4</td>
                                    <td class="border border-blue-700">4</td>
                                    <td class="border border-blue-700">4</td>
                                    <td class="border border-blue-700">4</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="border border-blue-700">5</td>
                                    <td class="border border-blue-700">5</td>
                                    <td class="border border-blue-700">5</td>
                                    <td class="border border-blue-700">5</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="border border-blue-700">6</td>
                                    <td class="border border-blue-700">6</td>
                                    <td class="border border-blue-700">6</td>
                                    <td class="border border-blue-700">6</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="border border-blue-700">7</td>
                                    <td class="border border-blue-700">7</td>
                                    <td class="border border-blue-700">7</td>
                                    <td class="border border-blue-700">7</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="border border-blue-700">8</td>
                                    <td class="border border-blue-700">8</td>
                                    <td class="border border-blue-700">8</td>
                                    <td class="border border-blue-700">8</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="border border-blue-700">9</td>
                                    <td class="border border-blue-700">9</td>
                                    <td class="border border-blue-700">9</td>
                                    <td class="border border-blue-700">9</td>
                                </tr>
                                ...
                                <tr>
                                    <td class="border border-blue-700">10</td>
                                    <td class="border border-blue-700">10</td>
                                    <td class="border border-blue-700">10</td>
                                    <td class="border border-blue-700">10</td>
                                </tr>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-x-2">
                    ...
                    <button id="btn-mod" onclick="modificarHerramienta();" class="btn-green btn-s py-1 px-7 w-1/4" style="display: none;">
                        Aceptar
                    </button>
